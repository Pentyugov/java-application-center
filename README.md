...
Десктопное приложение для управления набором Java `.jar` сервисов: хранение списка сервисов, запуск/остановка по одному и массово, управление JVM аргументами и переменными окружения, просмотр логов, а также быстрый Git checkout веток для связанных репозиториев.
